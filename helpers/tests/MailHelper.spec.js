...
describe('preProcessReplacements', () => {
  test('Processes the list of replacements', () => {
...
describe('loadTemplate', () => {
  test('Load a template from a file', async () => {
    const res = await helper.loadTemplate({
      type: 'path',
      encoding: 'utf-8',
...
describe('buildHeader', () => {
  test('Builds the header of a email', () => {
  ...
  test('Builds the header of a email with default values', () => {
    const res = helper.buildHeader({
      from: 'test@mail.com',
      to: ['target@mail.com'],
      subject: 'Subject',
